...
public class FileController {
    ...
    public void showImg(@RequestParam("filePath") String filePath
        ...
        String ext = filePath.substring(filePath.lastIndexOf(".") + 1); // 확장자 ➡ 마지막 .을 찾아서 뒤의 문자열을 가져오면 확장자가 됨
        MediaType mediaType = MediaUtil.getMediaType(ext);
        if (mediaType == null) return;
        log.info("medaiType : {}", mediaType);
...
// /file/img?filePath=C:/upload/sample.png
// /file/download?filePath=C:/upload/sample.png
